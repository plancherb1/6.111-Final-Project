...
*/
  ...
  debounce db_E(reset_init, clock_27mhz, ~button_enter, btnE_db);
  wire reset = reset_init | ~btnE_db;
  // rest of buttons
  debounce db_U #(.DELAY(270000))(.reset(reset), .clock(clock_27mhz), .noisy(~button_up), .clean(btnU_db);
  debounce db_D #(.DELAY(270000))(.reset(reset), .clock(clock_27mhz), .noisy(~button_down), .clean(btnD_db);
  debounce db_L #(.DELAY(270000))(.reset(reset), .clock(clock_27mhz), .noisy(~button_left), .clean(btnL_db);
  debounce db_R #(.DELAY(270000))(.reset(reset), .clock(clock_27mhz), .noisy(~button_right), .clean(btnR_db);
  debounce db_0 #(.DELAY(270000))(.reset(reset), .clock(clock_27mhz), .noisy(~button0), .clean(btn0_db);
  debounce db_1 #(.DELAY(270000))(.reset(reset), .clock(clock_27mhz), .noisy(~button1), .clean(btn1_db);
  debounce db_2 #(.DELAY(270000))(.reset(reset), .clock(clock_27mhz), .noisy(~button2), .clean(btn2_db);
  debounce db_3 #(.DELAY(270000))(.reset(reset), .clock(clock_27mhz), .noisy(~button3), .clean(btn3_db);
  // synchnozie all switches
  synchnozie(clock_27mhz,switch[0],db_switch[0]);
  synchnozie(clock_27mhz,switch[1],db_switch[1]);
  synchnozie(clock_27mhz,switch[2],db_switch[2]);
  synchnozie(clock_27mhz,switch[3],db_switch[3]);
  synchnozie(clock_27mhz,switch[4],db_switch[4]);
  synchnozie(clock_27mhz,switch[5],db_switch[5]);
  synchnozie(clock_27mhz,switch[6],db_switch[6]);
  synchnozie(clock_27mhz,switch[7],db_switch[7]);
  
  ////////////////////////////////////////////////////////////////////////////
  //
  // Set up the XVGA Output
  //
  ////////////////////////////////////////////////////////////////////////////
  ...
  // Ultrasound
  ultrasound_location_calculator ul(.clock(clock_27mhz),.reset(rest),
  ...
  vga_writer vg(.vclock(clock_65mhz),.reset(reset),.new_data(location_update),
				.move_command(move_command),.locaiton(rover_location),
  ...
  wire [64:0] my_hex_data = {64hFFFFFFFF);
